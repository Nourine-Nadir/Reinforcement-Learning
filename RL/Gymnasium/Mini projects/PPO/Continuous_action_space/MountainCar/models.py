...
class GenericNetwork(nn.Module):
    def __init__(self,
        ...
        #  Optimizer
        self.optimizer = T.optim.Adam(self.parameters(), lr=self.lr)
        self.scheduler = T.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=500, eta_min=self.min_lr)
    ...
    def sample(self, observation, n_outputs=1):
        #  Get mean and standard deviation
        ...
        return action_scaled, log_probs, dist
...
class GaussianPolicy(nn.Module):
    def __init__(self,
        ...
        #  Optimizer
        self.optimizer = T.optim.Adam(self.parameters(), lr=self.lr)
        self.scheduler = T.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=200, eta_min=self.min_lr)
